...
class EncoderDecoderLSTM(nn.Module):
    ...
    def __init__(
        ...
        # Initialising the bias to 1.0 means the untrained model already
        # predicts "no change", so training only needs to learn deviations.
        # Without this, the default near-zero bias causes the model to output
        # ratios ≈ 0 (return ≈ −1.0) until training fully converges, which
